...
INSERT INTO `ciudades` VALUES (1,73001,'2024-04-06','IBAGUE',1,1),(2,11001,'2024-04-06','BOGOTA, D.C.',2,1),(3,73002,'2024-04-06','ESPINAL',1,1),(4,11002,'2024-04-06','FUSA',2,1);
...
INSERT INTO `departamentos` VALUES (1,73,'2024-04-06','TOLIMA',1),(2,11,'2024-04-06','CUNDINAMARCA',1);
...
INSERT INTO `eapb` VALUES (1,'3108610210','2024-04-06','EL PAPAYO',111222333,'SANITAS@SANITAS.COM','MARIA','SANITAS',1,2,1),(2,'3108610210','2024-04-06','CARRERA 5 CALLE 42',222333444,'FAMISANAR@FAMISANAR.COM','MARIA','FAMISANAR',1,2,2),(3,'3108610210','2024-04-06','Mz D Casa 10 Brisas del pedregal',93414046,'julio_salcedo2@hotmail.com','JULIO','JES SOLUCIONES',1,1,4);
...
INSERT INTO `pac` VALUES (1,'SANDRA','3133692213','3108610210','3133692213','PEDREGAL','JULIO@JULIO.COM','CASADO','2024-04-06',NULL,'1979-11-03','93414046','SALCEDO','JULIO','SANDRA','PELAEZ','ERNESTO','MASCULINO',1,1,1,1,1),(2,'JULIO','3108610210','3133692213','3108610210','RICAUTE','SSANDRAPATRIDIAZ@HOTMAIL.COM','CASADO','2024-04-06',NULL,'1970-03-29','65748200','DIAZ','SANDRA','JULIO','GUTIERREZ','PATRICIA','FEMENINO',1,3,1,3,1);
...
INSERT INTO `status` VALUES (1,'2024-04-06','CREADO','CRE'),(2,'2024-04-06','ACTIVO','ACT'),(3,'2024-04-06','EDITADO','EDI'),(4,'2024-04-06','INACTIVO','INA');
...
INSERT INTO `tipac` VALUES (1,'2024-04-06','COTIZANTE','C',1),(2,'2024-04-06','BENEFICIARIO','B',1),(3,'2024-04-06','NO AFILIADO','NA',1);
...
INSERT INTO `tipdoc` VALUES (1,'2024-04-06','CEDULA DE CIUDADANIA','CC'),(2,'2024-04-06','NUMERO DE IDENTIFICACION TRIBUTARIA','NIT'),(3,'2024-04-06','REGISTRO CIVIL','RC'),(4,'2024-04-06','TARJETA DE IDENTIDAD','TI'),(5,'2024-04-06','PERMISO DE PERMANENCIA TEMPORAL','PPT'),(6,'2024-04-06','CEDULA DE EXTRANJERIA','CE'),(7,'2024-04-06','PASAPORTE','PA'),(8,'2024-04-06','PERMISO ESPECIAL DE PERMANENCIA','PEP');
...
INSERT INTO `tipeapb` VALUES (1,'2024-04-06','CONTRIBUTIVO','C',1),(2,'2024-04-06','SUBSIDIADO','S',1),(3,'2024-04-06','REGIMEN ESPECIAL','RE',1),(4,'2024-04-06','PARTICULAR','P',1);
...
-- Dump completed on 2024-04-07  0:53:34
