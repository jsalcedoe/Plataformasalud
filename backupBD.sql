...
CREATE TABLE `dxatehcpac` (
  ...
  `origdx_fk_idtypnot` bigint DEFAULT NULL,
  ...
  KEY `FKmhepo3jqy24qr9g3ye2yv3020` (`origdx_fk_idtypnot`),
  ...
  CONSTRAINT `FKmhepo3jqy24qr9g3ye2yv3020` FOREIGN KEY (`origdx_fk_idtypnot`) REFERENCES `tynote` (`idtypnot`),
